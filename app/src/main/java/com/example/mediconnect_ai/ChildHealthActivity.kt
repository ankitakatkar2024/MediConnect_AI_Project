...
class ChildHealthActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pageTitle = getString(R.string.resources_child_title)
        binding.toolbarLayout.title = pageTitle
        // --- END OF UPDATE ---

        // 3. Set the unique header image, title, and content for this page
        binding.headerImage.setImageResource(R.drawable.ic_child_health_header)
        ...
        val formattedText = HtmlCompat.fromHtml(
            getString(R.string.content_child_health),
