...
class GovSchemesActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pageTitle = getString(R.string.resources_schemes_title)
        binding.toolbarLayout.title = pageTitle
        // --- END OF UPDATE ---

        // 3. Set the unique header image, title, and content for this page
        binding.headerImage.setImageResource(R.drawable.ic_gov_schemes)
        ...
        val formattedText = HtmlCompat.fromHtml(
            getString(R.string.content_gov_schemes),
